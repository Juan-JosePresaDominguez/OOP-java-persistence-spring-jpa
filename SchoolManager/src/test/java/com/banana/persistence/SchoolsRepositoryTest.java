...
class SchoolsRepositoryTest {
    ...
    @Autowired
    private SchoolsRepositoryInf repoSchools;
    ...
    @Test
    void add() {
        //EntityManager em = emf.createEntityManager();     --> Lo quitamos al crear 'before'
    ...
    @Test
    void update() {
        School sch = new School(1L, "Mi escuela cambió", null);
        School schC = repoSchools.update(sch);
        assertNotNull(sch);
    ...
    @Test
    void getById() {
        School sch = repoSchools.getById(1L);
        assertNotNull(sch);
    }
